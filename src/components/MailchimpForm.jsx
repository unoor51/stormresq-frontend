...
const MailchimpForm = () => {
  return (
    <div id="mc_embed_signup" className="bg-white p-6 rounded-md shadow-md max-w-xl w-full mx-auto border border-gray-200">
    <form
    ...
    >
        ...
        <h2 className="text-2xl font-bold mb-4 text-center text-gray-600">Subscribe</h2>
        <div className="indicates-required text-sm text-gray-600 mb-4">
            <span className="asterisk text-red-500">*</span> indicates required
        </div>
        <div className="mc-field-group mb-6">
            <label htmlFor="mce-FNAME" className="block font-medium mb-4 text-gray-600 text-left">
            First Name
            </label>
            <input
            type="text"
        ...
        <div className="mc-field-group mb-6">
            <label htmlFor="mce-EMAIL" className="block font-medium mb-4 text-gray-600 text-left">
        ...
        <div className="clear">
            ...
            className="button bg-orange-600 hover:bg-orange-700 text-white font-semibold px-6 py-2 rounded w-full"
            value="Subscribe"
            />
        </div>
        </div>
